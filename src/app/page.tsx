      ...
      <div className="mx-auto max-w-2xl lg:max-w-4xl">
        <figure className="mt-10">
          <blockquote className="text-center text-xl font-semibold leading-8 text-gray-900 sm:text-2xl sm:leading-9">
            <p>
              “Zsuzsanna segített már több ingatlan adás-vételünknél is, nagyon meg vagyunk vele elégedve. Mindig
              gyorsan és precízen dolgozik, több rizikós helyzetet kerültünk már el amiatt, mert körültekintően és
              alaposan dolgozott.”
            </p>
          </blockquote>
          <figcaption className="mt-10">
            ...
            <div className="mt-4 flex items-center justify-center space-x-3 text-base">
              <div className="font-semibold text-gray-900">Ingatlan ügyes ügyfél</div>
